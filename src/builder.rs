...
impl<'c> Builder<'c> {
    /// Returns the parent context of the builder
    pub fn context(&self) -> &'c Context {
        self.context
    }

    /// Build a stack allocation
    pub fn build_alloca(&self, ty: Type<'c>) -> Value<'c> {
        Value {
    ...
    pub fn build_malloc(&self, ty: Type<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_array_alloca(&self, ty: Type<'c>, count: u32) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
                LLVMBuildArrayAlloca(self.builder.unwrap(), ty.ty, self.context.ty_i32().const_int(count as u64).value, into_c("").as_ptr())
            }
        }
    }

    /// Build a heap allocation for an array
    pub fn build_array_malloc(&self, ty: Type<'c>, count: u32) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
                LLVMBuildArrayMalloc(self.builder.unwrap(), ty.ty, self.context.ty_i32().const_int(count as u64).value, into_c("").as_ptr())
            }
        }
    }

    /// Build a heap free
    pub fn build_free(&self, ptr: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_call(&self, func: Value<'c>, args: Vec<Value<'c>>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_struct_init(&self, ty: Type<'c>, elements: Vec<Value<'c>>) -> Value<'c> {
        let mut agg: Value<'c> = ty.undef();
    ...
    pub fn build_insert_value(&self, agg: Value<'c>, elt: Value<'c>, index: u32) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_extract_value(&self, agg: Value<'c>, index: u32) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_gep(&self, ptr: Value<'c>, indices: Vec<Value<'c>>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_struct_gep(&self, ptr: Value<'c>, index: u32) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_inbounds_gep(&self, ptr: Value<'c>, indices: Vec<Value<'c>>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
                LLVMBuildGEP(self.builder.unwrap(), ptr.value,
    ...
    pub fn build_global_string<S>(&self, string: S) -> Value<'c> where S: AsRef<str> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_global_string_ptr<S>(&self, string: S) -> Value<'c> where S: AsRef<str> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_store(&self, val: Value<'c>, ptr: Value<'c>) {
        unsafe {
    ...
    pub fn build_load(&self, ptr: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_array_alloca_store(&self, ty: Type<'c>, elements: Vec<Value<'c>>) -> Value<'c> {
        let mut agg = self.context.ty_array(ty, elements.len() as u32).undef();
    ...
    pub fn build_array_malloc_store(&self, ty: Type<'c>, elements: Vec<Value<'c>>) -> Value<'c> {
        let mut agg = self.context.ty_array(ty, elements.len() as u32).undef();
        for (i, element) in elements.into_iter().enumerate() {
            agg = self.build_insert_value(agg, element, i as u32).name(format!("insert_elem_{}", i));
        }
    ...
    pub fn build_alloca_store(&self, val: Value<'c>) -> Value<'c> {
    ...
    pub fn build_malloc_store(&self, val: Value<'c>) -> Value<'c> {
    ...
    pub fn build_load_free(&self, ptr: Value<'c>) -> Value<'c> {
    ...
    pub fn build_int_to_ptr(&self, val: Value<'c>, ptr_ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_ptr_to_int(&self, ptr: Value<'c>, val_ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_pointer_cast(&self, ptr: Value<'c>, ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_cast(&self, val: Value<'c>, ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    /// Build a bit cast
    pub fn build_bit_cast(&self, val: Value<'c>, ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_cast(&self, val: Value<'c>, ty: Type) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_ret_void(&self) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_ret(&self, val: Value<'c>) -> Value<'c> where {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_if(&self, condition: Value<'c>, then_block: BasicBlock, else_block: BasicBlock) {
        unsafe {
    ...
    pub fn build_switch(&self, val: Value<'c>, cases: Vec<(Value<'c>, BasicBlock)>, default: BasicBlock) {
        unsafe {
    ...
    pub fn build_phi(&self, incoming: Vec<(Value<'c>, BasicBlock)>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn position_in_block(&self, bb: BasicBlock, val: Value<'c>) {
        unsafe {
    ...
    pub fn position_before(&self, val: Value<'c>) {
        unsafe {
    ...
    /// Builds a null check
    pub fn build_is_null(&self, val: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    /// Builds a null check
    pub fn build_is_not_null(&self, val: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_add(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_sub(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_mul(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_udiv(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_sdiv(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_urem(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_srem(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
                LLVMBuildSRem(self.builder.unwrap(), a.value, b.value, into_c("").as_ptr())
    ...
    pub fn build_int_eq(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_ne(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_ule(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_ult(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_uge(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_ugt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_sle(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_slt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_sge(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_int_sgt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_add(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_sub(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_mul(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_div(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_rem(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_eq(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ne(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_le(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_lt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ge(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_gt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_eq(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_ne(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_le(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_lt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_ge(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_ord_gt(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_is_ord(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
    ...
    pub fn build_float_non_ord(&self, a: Value<'c>, b: Value<'c>) -> Value<'c> {
        Value {
            context: self.context,
            value: unsafe {
